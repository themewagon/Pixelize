  ...
  return (
    <>
      <div>
        <div
          role='status'
          className='max-w-md animate-pulse overflow-hidden text-center backdrop-blur-md p-8 bg-white dark:bg-lightdarkblue rounded-lg border border-black/10'>
          <svg
...
export default SpecializeSkeleton
